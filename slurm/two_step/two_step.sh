...
generated_script_path="/home/$USER/cse3000/slurm/two_step/scripts/${job_name}.sh"
...
#SBATCH --output=/home/%u/cse3000/slurm/two_step/%x_%j.out
#SBATCH --error=/home/%u/cse3000/slurm/two_step/%x_%j.err
